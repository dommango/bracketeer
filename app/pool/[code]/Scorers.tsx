import type { getTopScorers, getGoalscorerOutrights } from "@/lib/pool/queries";
import { Flag } from "./Flag";

// Golden Boot leaderboard + betting favorites. Presentational only — data is
// fetched by the caller (the Matches "scorers" sub-view and the legacy redirect
// both reuse this), so the encoding lives in one place.
type Scorer = Awaited<ReturnType<typeof getTopScorers>>[number];
type Favorite = Awaited<ReturnType<typeof getGoalscorerOutrights>>[number];
